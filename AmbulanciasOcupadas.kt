...
class AmbulanciasOcupadas : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_ambulancias_ocupadas)

        val lv=findViewById<ListView>(R.id.AMBULOCUPADAS)
        val arregloAmbulancias = SistemaDeUrgencias.arrayAmbuFULL()
